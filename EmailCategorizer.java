...
public class EmailCategorizer {
    ...
    private static final String[] School_Values = {"student", "canvas", "assignments", "class", "labs", "review", "piazza", "learning", "skill", "github", "classroom", "usfca", "usf"};
    ...
    private static final String[] Student_Values = {"@dons.usfca.edu"};
    private static final String[] Teacher_Values = {"@usfca.edu"};
    ...
    public EmailCategorizer() {
        ...
        categories.put(Student_Category, Student_Values);
        categories.put(Teacher_Category, Teacher_Values);
    ...
    public String customCategorize(String subject) {
